...
CMD echo "$HOME/.ops/bin/ops image create --nightly --package node_v14.2.0 -c config.json -i new_img && cd $HOME/.ops/images/ && mkdir /images && cp $HOME/.ops/images/new_img.img /images/new_img.img" > commands.txt && cat commands.txt | bash
